...
if (btn && localStorage.getItem('theme') === 'dark') {
    btn.innerHTML = '<img src="/afritech-elite/equipes/icons/mode-jour.png" alt="" aria-hidden="true" width="30" height="30">';
}
...
function toggleTheme() {
    ...
    if (html.getAttribute('data-theme') === 'dark') {
        ...
        btn.innerHTML = '<img src="/afritech-elite/equipes/icons/nouvelle-lune.png" alt="" aria-hidden="true" width="30" height="30">';
    } else {
